    ...
    <div class="recipe-card">
      <div>
        <div class="recipe-header">
          ...
          <span class="recipe-number">06</span>
        </div>
    ...
    <div class="recipe-card">
      <div>
        <div class="recipe-header">
          ...
          <span class="recipe-number">07</span>
        </div>
        <div class="recipe-thumbnail">
          <svg width="100%" height="30" viewBox="0 0 120 30" fill="none">
    ...
    <div class="recipe-card">
      <div>
        <div class="recipe-header">
          ...
          <span class="recipe-number">08</span>
        </div>
        <div class="recipe-thumbnail">
          <svg width="100%" height="30" viewBox="0 0 120 30" fill="none">
    ...
    <div class="recipe-card">
      <div>
        <div class="recipe-header">
          ...
          <span class="recipe-number">09</span>
        </div>
        <div class="recipe-thumbnail">
          <svg width="100%" height="30" viewBox="0 0 120 30" fill="none">
    ...
    <div class="recipe-card">
      <div>
        <div class="recipe-header">
          ...
          <span class="recipe-number">10</span>
        </div>
        <div class="recipe-thumbnail">
          <svg width="100%" height="30" viewBox="0 0 120 30" fill="none">
...
<div class="recipes-container" id="resources">
  ...
  <div class="resource-card">
    <div style="margin-bottom: 12px; color: #ff0000;">
  ...
  <div class="footer-grid">
    ...
    <a href="https://github.com/sub-shi" target="_blank" style="display: flex; align-items: center; gap: 8px;">
      ...
      GitHub
        ...
        <li>
    <a href="https://youtube.com" target="_blank" style="display: flex; align-items: center; gap: 8px;">
